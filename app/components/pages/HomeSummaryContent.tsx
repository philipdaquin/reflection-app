...
import { AudioData, DEFAULT_IMAGE_URL, DailySummary, TextClassification } from '../../typings';
...
function HomeSummaryContent({all_mood_data, recent_entries, dailyMoodSummary} : Props) {
