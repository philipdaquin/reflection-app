...
import ChangeEmail, {
  EmailConfirmation,
} from "../components/profile/desktop/options/ChangeEmail";
...
function Home({
  ...
  const [weeklySummary, setWeeklySummary] =
    useRecoilState<WeeklySummary | null>(CurrentWeekSummary);
  const [audioEntries, setAudioEntries] = useState<AudioData[] | null>(
    weekly_entries
  );
  ...
  }, [selectedFilter, weekly_entries, recent_entries]);
