...
function signin() {
  ...
  const buttonVariant =
    ...
    !errors.email &&
    !errors.password
      ? GenericButtonVariant.FILLED
      : GenericButtonVariant.EMPTY;
        ...
        <main className="w-[411px]">
          <div className="text-center flex flex-col justify-center">
            ...
            <form action="" className="" onSubmit={handleSubmit(onSubmit)}>
              ...
              <label
                htmlFor=""
                className="inline-bkock w-full space-y-1 h-[67px]"
              >
                <input
                  type="password"
              ...
              <Link
                href={"/password_reset"}
                className="cursor-pointer mt-3 inline-block w-full"
              >
                <h2 className="text-xs font-bold text-center hover:underline">
                  Forgot Password?
                </h2>
              </Link>
              ...
              <div className="mt-[40px] space-y-12">
                ...
                <h1 className=" font-medium text-[#424242] text-[15px] text-center">
                  ...
                  <span className="font-semibold underline cursor-pointer ml-1">
                    <Link href="/onboarding/signup">Sign up for free</Link>
                  </span>
                </h1>
              </div>
            </form>
